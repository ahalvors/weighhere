...
NAV = [
    ...
    ("/fresno/", "Fresno / Hwy 99 · I-5", "fre"),
    ("/merced/", "Merced / Hwy 99", "mer"),
  ...
  <div class="wrap">
    <nav aria-label="Footer">
      <ul>
        ...
        <li><a href="/tulare/">Tulare / Hwy 99</a></li>
        <li><a href="/bakersfield/">Bakersfield / Hwy 99</a></li>
        <li><a href="/fresno/">Fresno / Hwy 99 · I-5</a></li>
        <li><a href="/merced/">Merced / Hwy 99</a></li>
...
def tulare_body():
    order = [
        "loves-382-tulare",
        "flying-j-1071-tulare",
    ]
    by_id = {s["id"]: s for s in STATIONS}
    tul = [by_id[i] for i in order if i in by_id]
    dedicated = [s for s in tul if s["display_group"] == "dedicated"]
    cat = [s for s in tul if s["display_group"] == "cat"]
    cards_c = "\n".join(card(s) for s in cat)
    n = len(tul)
    return f"""
<main id="main">
<section class="page-head">
  <div class="wrap">
    <p class="kicker">Tulare · Hwy 99 · Tulare County · listings checked {CHECKED_HUMAN}</p>
    <h1>Public scales on Hwy 99 at Tulare</h1>
    <p class="lede">Two CAT Scales verified on Love’s and Pilot Flying J <em>own</em> location pages at CA-99 Exit 85 in Tulare: Love’s #382 (Blackstone) and Flying J #1071 (Paige Ave). No ScaleRegistry dedicated walk-up house in Tulare. CDFA Tulare grid did not load on this compile (WAF blocked). Third-party CAT listings for Earlimart / Goshen / Visalia are omitted until an operator page we treat as primary confirms CAT. For Selma and Merced dedicated houses, use the <a href="/central-valley/">Central Valley</a> page; for Madera CA-99, see <a href="/madera/">Madera / Hwy 99</a>.</p>
    <p class="meta-line">{n} verified listings · {len(dedicated)} dedicated houses · {len(cat)} CAT stops · CDFA grid not loaded</p>
  </div>
</section>
<div class="wrap prose">
  {filters()}
  <div class="box box-call" id="dedicated">
    <h2>No verified dedicated public scale house in Tulare</h2>
    <p>ScaleRegistry’s California public-weighing list still points to <strong>Selma</strong> and <strong>Merced</strong> for the broader Central Valley — <strong>no Tulare dedicated house</strong>. Use the <a href="/central-valley/">Central Valley page</a> for those walk-up ticket shops. We are not inventing a civilian ticket shop from third-party trucker directories.</p>
  </div>

  <div data-filter-section>
  <h2 class="section-h" id="cat">CAT Scale at Love’s and Flying J</h2>
  <p class="section-note">We list only corridor CAT stops verified on the operator’s own location page. Love’s #382 (Tulare / CA-99 Exit 85 / Blackstone) and Flying J #1071 (Tulare / CA-99 Exit 85 / Paige Ave) each list CAT Scale / CAT Scales. 2,000 lb floor. No corner weights. Do not unload horses at a truck stop. In California, go inside for a printed weighmaster certificate when you need one. Use <a href="https://catscale.com/cat-scale-locator/">CAT’s locator</a> for other stops.</p>
  <div class="cards two">{cards_c}</div>
  </div>
  ...
  <div class="box box-call">
    <h3>What we still need to verify</h3>
    <p>Full CDFA Tulare public-scale grid (blocked on this compile). Any dedicated walk-up weighmaster house in Tulare / Visalia with an operator page. Livestock policy. Other Hwy 99 CAT stops between Madera and Bakersfield (Earlimart, Goshen, Visalia) whose own pages list CAT — not third-party directories.</p>
  </div>
  <p class="cite">Sources: <a href="https://www.loves.com/locations/ca/tulare/loves-travel-stop-tulare-382">Love’s #382 Tulare</a> · <a href="https://locations.pilotflyingj.com/us/ca/tulare/979-e-paige-ave">Flying J #1071 Tulare</a> · <a href="https://catscale.com/cat-scale-locator/">CAT Scale locator</a> (linked, not republished) · <a href="https://scaleregistry.com/public-scales.html">ScaleRegistry public scales</a> · CDFA Tulare grid: blocked</p>
  <div class="related">
    <h2>Related</h2>
    <ul>
      <li><a href="/madera/">Madera / Hwy 99 public scales</a></li>
...
def fresno_body():
    order = [
        "selma-certified-public-scale",
        "ez-trip-1277-huron",
    ]
    by_id = {s["id"]: s for s in STATIONS}
    fre = [by_id[i] for i in order if i in by_id]
    dedicated = [s for s in fre if s["display_group"] == "dedicated"]
    cat = [s for s in fre if s["display_group"] == "cat"]
    cards_d = "\n".join(card(s) for s in dedicated)
    cards_c = "\n".join(card(s) for s in cat)
    n = len(fre)
    return f"""
...
<section class="page-head">
  <div class="wrap">
    <p class="kicker">Fresno · Hwy 99 · I-5 · Fresno County · listings checked {CHECKED_HUMAN}</p>
    <h1>Public scales in Fresno County</h1>
    <p class="lede">One ScaleRegistry dedicated walk-up house plus one CAT Scale verified on Pilot Flying J’s <em>own</em> location page in Fresno County: <strong>Selma Certified Public Scale</strong> (Hwy 99 / Mountain View Ave) and <strong>EZ Trip #1277 Huron</strong> (I-5 Exit 319 / S. Lassen Ave). No Love’s or Pilot city store page in Fresno / Fowler / Kingsburg / Clovis / Firebaugh / Coalinga listed CAT on this compile. CDFA Fresno grid (c=10) WAF-blocked. Selma also appears on the broader <a href="/central-valley/">Central Valley</a> page; Madera and Tulare Hwy 99 CAT stops ship on their corridor pages.</p>
    <p class="meta-line">{n} verified listings · {len(dedicated)} dedicated house · {len(cat)} CAT stop · CDFA grid not loaded</p>
  </div>
</section>
<div class="wrap prose">
  {filters()}
  <div data-filter-section>
  <h2 class="section-h" id="dedicated">Dedicated public scale</h2>
  <p class="section-note">Selma Certified Public Scale is on ScaleRegistry’s California public-weighing list and on the operator’s own site. Call to confirm they will weigh your civilian U-Haul, RV, horse trailer, or PPM combination and issue a California weighmaster certificate. Livestock policy not published. Not a DOT station.</p>
  <div class="cards">{cards_d}</div>
  </div>

  <div data-filter-section>
  <h2 class="section-h" id="cat">CAT Scale at EZ Trip (Pilot network)</h2>
  <p class="section-note">We list only corridor CAT stops verified on the operator’s own location page. EZ Trip #1277 Huron (I-5 Exit 319) lists CAT Scale among amenities and the FAQ confirms a CAT scale. 2,000 lb floor. No corner weights. Do not unload horses at a truck stop. In California, go inside for a printed weighmaster certificate when you need one. Use <a href="https://catscale.com/cat-scale-locator/">CAT’s locator</a> for other stops. Third-party CAT pins in Fresno / Fowler / Traver omitted until an operator page we treat as primary confirms CAT.</p>
  <div class="cards two">{cards_c}</div>
  </div>
  ...
  <div class="box box-call">
    <h3>What we still need to verify</h3>
    <p>Full CDFA Fresno public-scale grid (blocked on this compile). Any second Fresno / Fowler / Kingsburg / Clovis / Firebaugh / Coalinga CAT stop whose <em>own</em> operator page lists CAT. Livestock policy at Selma. Hours / fees beyond Selma’s published store window. TA Livingston #0170 now ships on the <a href="/merced/">Merced / Hwy 99</a> page with Highway 59 Scales.</p>
  </div>
  <p class="cite">Sources: <a href="https://selmacertifiedpublicscale.com/">Selma Certified Public Scale</a> · <a href="https://locations.pilotflyingj.com/us/ca/huron/44779-s.-lassen-avenue">EZ Trip #1277 Huron</a> · <a href="https://catscale.com/cat-scale-locator/">CAT Scale locator</a> (linked, not republished) · <a href="https://scaleregistry.com/public-scales.html">ScaleRegistry public scales</a> · CDFA Fresno grid: blocked</p>
  <div class="related">
    <h2>Related</h2>
    <ul>
      <li><a href="/central-valley/">Central Valley public scales</a></li>
      <li><a href="/merced/">Merced / Hwy 99 public scales</a></li>
      <li><a href="/madera/">Madera / Hwy 99 public scales</a></li>
      <li><a href="/tulare/">Tulare / Hwy 99 public scales</a></li>
      <li><a href="/bakersfield/">Bakersfield / Hwy 99 public scales</a></li>
      <li><a href="/buttonwillow-lost-hills/">Buttonwillow / Lost Hills / I-5 public scales</a></li>
      <li><a href="/how-to-weigh-an-rv/">How to weigh an RV or fifth-wheel at a CAT Scale</a></li>
      <li><a href="/ppm-dity-southern-california/">Military PPM / DITY weight tickets in Southern California</a></li>
      <li><a href="/public-scale-vs-weigh-station/">Public scale vs highway weigh station</a></li>
...
def merced_body():
    order = [
        "highway-59-scales-merced",
        "ta-livingston-0170",
    ]
    by_id = {s["id"]: s for s in STATIONS}
    mer = [by_id[i] for i in order if i in by_id]
    dedicated = [s for s in mer if s["display_group"] == "dedicated"]
    cat = [s for s in mer if s["display_group"] == "cat"]
    cards_d = "\n".join(card(s) for s in dedicated)
    cards_c = "\n".join(card(s) for s in cat)
    n = len(mer)
    return f"""
...
<section class="page-head">
  <div class="wrap">
    <p class="kicker">Merced · Livingston · Hwy 99 · Merced County · listings checked {CHECKED_HUMAN}</p>
    <h1>Public scales on Hwy 99 at Merced and Livingston</h1>
    <p class="lede">One ScaleRegistry dedicated walk-up house plus one CAT Scale verified on TravelCenters of America’s <em>own</em> location page in Merced County: <strong>Highway 59 Scales</strong> (1260 CA-59, Merced) and <strong>TA Livingston #0170</strong> (SR 99 Exit 203 / Winton Parkway). No Love’s or Pilot city store page in Merced / Livingston / Atwater / Los Banos listed CAT on this compile. CDFA Merced grid WAF-blocked. Highway 59 also appears on the broader <a href="/central-valley/">Central Valley</a> page; Santa Nella I-5 CAT stops ship on <a href="/santa-nella/">Santa Nella / I-5</a>.</p>
    <p class="meta-line">{n} verified listings · {len(dedicated)} dedicated house · {len(cat)} CAT stop · CDFA grid not loaded</p>
  </div>
</section>
<div class="wrap prose">
  ...
  <div data-filter-section>
  <h2 class="section-h" id="dedicated">Dedicated public scale</h2>
  <p class="section-note">Highway 59 Scales is on ScaleRegistry’s California public-weighing list (address and phone). No operator site published hours, fees, or livestock policy on this compile. Call to confirm they will weigh your civilian U-Haul, RV, horse trailer, or PPM combination and issue a California weighmaster certificate. Not a DOT station.</p>
  <div class="cards">{cards_d}</div>
  </div>

  <div data-filter-section>
  <h2 class="section-h" id="cat">CAT Scale at TA</h2>
  <p class="section-note">We list only corridor CAT stops verified on the operator’s own location page. TA #0170 Livingston (SR 99 Exit 203 / Winton Parkway) lists CAT Scale among amenities. 2,000 lb floor. No corner weights. Do not unload horses at a truck stop. In California, go inside for a printed weighmaster certificate when you need one. Use <a href="https://catscale.com/cat-scale-locator/">CAT’s locator</a> for other stops. ONE9 #1424 Westley (I-5) still deferred — CAT appears in Pilot page JSON/description strings but the visible amenities card was not clear enough for this directory on this compile.</p>
  <div class="cards two">{cards_c}</div>
  </div>
  ...
  <div class="box box-call">
    <h3>What we still need to verify</h3>
    <p>Full CDFA Merced public-scale grid (blocked on this compile). Hours / fees / livestock at Highway 59 Scales. Any second Merced / Atwater / Los Banos / Gustine CAT stop whose <em>own</em> operator page lists CAT. ONE9 #1424 Westley visible amenities re-check for a Santa Nella / I-5 extension. Redding / Anderson still only has one own-page CAT (TA #0057).</p>
  </div>
  <p class="cite">Sources: <a href="https://scaleregistry.com/companies/highway-59-scales">Highway 59 Scales (ScaleRegistry)</a> · <a href="https://www.ta-petro.com/location/ca/ta-livingston/">TA #0170 Livingston</a> · <a href="https://catscale.com/cat-scale-locator/">CAT Scale locator</a> (linked, not republished) · <a href="https://scaleregistry.com/public-scales.html">ScaleRegistry public scales</a> · CDFA Merced grid: blocked</p>
  <div class="related">
    <h2>Related</h2>
    <ul>
      <li><a href="/central-valley/">Central Valley public scales</a></li>
      <li><a href="/fresno/">Fresno / Hwy 99 · I-5 public scales</a></li>
      <li><a href="/madera/">Madera / Hwy 99 public scales</a></li>
      <li><a href="/santa-nella/">Santa Nella / I-5 public scales</a></li>
      <li><a href="/highway-99/">Hwy 99 / Stockton approaches public scales</a></li>
      <li><a href="/how-to-weigh-an-rv/">How to weigh an RV or fifth-wheel at a CAT Scale</a></li>
...
def salinas_body():
    ...
    by_id = {s["id"]: s for s in STATIONS}
    sal = [by_id[i] for i in order if i in by_id]
    dedicated = [s for s in sal if s["display_group"] == "dedicated"]
    cat = [s for s in sal if s["display_group"] == "cat"]
    cards_c = "\n".join(card(s) for s in cat)
    n = len(sal)
    return f"""
<main id="main">
<section class="page-head">
  <div class="wrap">
    <p class="kicker">Salinas · US-101 · Monterey County · listings checked {CHECKED_HUMAN}</p>
    <h1>Public scales on US-101 at Salinas</h1>
    <p class="lede">Two CAT Scales verified on Love’s and Pilot Flying J <em>own</em> location pages at US-101 Exit 326 in Salinas: Love’s #898 (De La Torre / Exit 326A) and Pilot #237 (Work St / Exit 326B). No ScaleRegistry dedicated walk-up house in Monterey County on this compile. CDFA Monterey grid did not load (WAF blocked). Gilroy Garlic Farm third-party CAT and undeclared Pilot/Love’s Gilroy CAT rows omitted until an operator page we treat as primary confirms CAT. For I-5 inland CAT (Santa Nella / Patterson), use the <a href="/grapevine/">Grapevine / I-5 mid-CA</a> page.</p>
    <p class="meta-line">{n} verified listings · {len(dedicated)} dedicated houses · {len(cat)} CAT stops · CDFA grid not loaded</p>
  </div>
</section>
<div class="wrap prose">
  {filters()}
  <div class="box box-call" id="dedicated">
    <h2>No verified dedicated public scale house in Salinas</h2>
    <p>ScaleRegistry’s California public-weighing list still points to inland Central Valley houses (Selma / Merced) — <strong>no Monterey / Salinas dedicated house</strong> verified on this compile. We are not inventing a civilian ticket shop from third-party trucker directories.</p>
  </div>

  <div data-filter-section>
  <h2 class="section-h" id="cat">CAT Scale at Love’s and Pilot</h2>
  <p class="section-note">We list only corridor CAT stops verified on the operator’s own location page. Love’s #898 (Salinas / US-101 Exit 326A / De La Torre) and Pilot #237 (Salinas / US-101 Exit 326B / Work St) each list CAT Scale / CAT Scales. 2,000 lb floor. No corner weights. Do not unload horses at a truck stop. In California, go inside for a printed weighmaster certificate when you need one. Use <a href="https://catscale.com/cat-scale-locator/">CAT’s locator</a> for other stops.</p>
  <div class="cards two">{cards_c}</div>
  </div>
  ...
  <div class="box box-call">
    <h3>What we still need to verify</h3>
    <p>Full CDFA Monterey public-scale grid (blocked on this compile). Any dedicated walk-up weighmaster house in Salinas / Monterey with an operator page. Livestock policy. Other US-101 CAT stops (Gilroy Garlic Farm, King City, Prunedale) whose own pages list CAT — not third-party directories. Far-north I-5 CAT now ships on the <a href="/weed-yreka/">Weed / Yreka / I-5</a> page.</p>
  </div>
  <p class="cite">Sources: <a href="https://www.loves.com/locations/ca/salinas/loves-travel-stop-salinas-898">Love’s #898 Salinas</a> · <a href="https://locations.pilotflyingj.com/us/ca/salinas/951-work-st">Pilot #237 Salinas</a> · <a href="https://catscale.com/cat-scale-locator/">CAT Scale locator</a> (linked, not republished) · <a href="https://scaleregistry.com/public-scales.html">ScaleRegistry public scales</a> · CDFA Monterey grid: blocked</p>
  <div class="related">
    <h2>Related</h2>
    <ul>
      <li><a href="/grapevine/">Grapevine / I-5 mid-CA public scales</a></li>
...
def weed_yreka_body():
    ...
    by_id = {s["id"]: s for s in STATIONS}
    wy = [by_id[i] for i in order if i in by_id]
    dedicated = [s for s in wy if s["display_group"] == "dedicated"]
    cat = [s for s in wy if s["display_group"] == "cat"]
    cards_c = "\n".join(card(s) for s in cat)
    n = len(wy)
    return f"""
<main id="main">
<section class="page-head">
  <div class="wrap">
    <p class="kicker">Weed · Yreka · I-5 far north · Siskiyou County · listings checked {CHECKED_HUMAN}</p>
    <h1>Public scales on I-5 at Weed and Yreka</h1>
    <p class="lede">Two CAT Scales verified on Pilot Flying J <em>own</em> location pages on far-north I-5 in Siskiyou County: Pilot #137 Weed (I-5 Exit 745 / E Vista Dr) and EZ Trip Dealer #1343 Yreka (I-5 Exit 776 / Montague Rd). No ScaleRegistry dedicated walk-up house in Weed / Yreka / Siskiyou on this compile. CDFA Siskiyou grid did not load (WAF blocked). For mid-California I-5 CAT (Lebec / Santa Nella / Patterson), use the <a href="/grapevine/">Grapevine / I-5 mid-CA</a> page; for Sacramento-approach I-5 CAT, use <a href="/sacramento/">Sacramento approaches</a>.</p>
    <p class="meta-line">{n} verified listings · {len(dedicated)} dedicated houses · {len(cat)} CAT stops · CDFA grid not loaded</p>
  </div>
</section>
<div class="wrap prose">
  {filters()}
  <div class="box box-call" id="dedicated">
    <h2>No verified dedicated public scale house in Weed / Yreka</h2>
    <p>ScaleRegistry’s California public-weighing list still points to inland Central Valley houses (Selma / Merced) — <strong>no Siskiyou / Weed / Yreka dedicated house</strong> verified on this compile. We are not inventing a civilian ticket shop from third-party trucker directories.</p>
  </div>

  <div data-filter-section>
  <h2 class="section-h" id="cat">CAT Scale at Pilot and EZ Trip</h2>
  <p class="section-note">We list only corridor CAT stops verified on the operator’s own location page. Pilot #137 (Weed / I-5 Exit 745 / E Vista Dr) and EZ Trip Dealer #1343 (Yreka / I-5 Exit 776 / Montague Rd) each list CAT Scale. 2,000 lb floor. No corner weights. Do not unload horses at a truck stop. In California, go inside for a printed weighmaster certificate when you need one. Use <a href="https://catscale.com/cat-scale-locator/">CAT’s locator</a> for other stops.</p>
  <div class="cards two">{cards_c}</div>
  </div>
  ...
  <div class="box box-call">
    <h3>What we still need to verify</h3>
    <p>Full CDFA Siskiyou public-scale grid (blocked on this compile). Any dedicated walk-up weighmaster house in Weed / Yreka / Mount Shasta with an operator page. Livestock policy. Other far-north I-5 CAT stops whose own pages list CAT — not third-party directories. Mid-north Corning / Orland CAT now ships on the <a href="/corning-orland/">Corning / Orland / I-5</a> page.</p>
  </div>
  <p class="cite">Sources: <a href="https://locations.pilotflyingj.com/us/ca/weed/395-e-vista-dr">Pilot #137 Weed</a> · <a href="https://locations.pilotflyingj.com/us/ca/yreka/787-montague-rd">EZ Trip #1343 Yreka</a> · <a href="https://catscale.com/cat-scale-locator/">CAT Scale locator</a> (linked, not republished) · <a href="https://scaleregistry.com/public-scales.html">ScaleRegistry public scales</a> · CDFA Siskiyou grid: blocked</p>
  <div class="related">
    <h2>Related</h2>
    <ul>
...
def corning_orland_body():
    ...
    by_id = {s["id"]: s for s in STATIONS}
    co = [by_id[i] for i in order if i in by_id]
    dedicated = [s for s in co if s["display_group"] == "dedicated"]
    cat = [s for s in co if s["display_group"] == "cat"]
    cards_c = "\n".join(card(s) for s in cat)
    n = len(co)
    return f"""
<main id="main">
...
<div class="wrap prose">
  {filters()}
  <div class="box box-call" id="dedicated">
    <h2>No verified dedicated public scale house in Corning / Orland</h2>
    <p>ScaleRegistry’s California public-weighing list still points to inland Central Valley houses (Selma / Merced / Lancaster) — <strong>no Tehama / Glenn / Corning / Orland dedicated house</strong> verified on this compile. We are not inventing a civilian ticket shop from third-party trucker directories.</p>
  </div>
  ...
  <div class="box box-warn" id="do-not-go">
    <h2>Do not go here for a ticket</h2>
    <p>California Commercial Vehicle Enforcement Facilities (CHP weigh stations) are for commercial enforcement — not a place to buy a civilian weighmaster ticket for a U-Haul, RV, horse trailer, or PPM load. Cottonwood and other I-5 CVEFs near Redding are not ticket shops. See Caltrans’ weigh-station primer and follow posted signs; do not treat this directory as a bypass guide.</p>
    <p class="cite">Source: <a href="https://dot.ca.gov/programs/traffic-operations/cvef/weigh-stations">Caltrans — Weigh-Stations (Enforcement Facilities)</a></p>
  </div>
...
def wheeler_ridge_body():
    order = [
        "ta-wheeler-ridge-0239",
        "petro-wheeler-ridge-0327",
    ]
    by_id = {s["id"]: s for s in STATIONS}
    wr = [by_id[i] for i in order if i in by_id]
    dedicated = [s for s in wr if s["display_group"] == "dedicated"]
    cat = [s for s in wr if s["display_group"] == "cat"]
    cards_c = "\n".join(card(s) for s in cat)
    n = len(wr)
    return f"""
<main id="main">
<section class="page-head">
  <div class="wrap">
    <p class="kicker">Wheeler Ridge · Laval Road · I-5 · Kern County · listings checked {CHECKED_HUMAN}</p>
    <h1>Public scales on I-5 at Wheeler Ridge</h1>
    <p class="lede">Two CAT Scales verified on TravelCenters of America and Petro <em>own</em> location pages at the I-5 Laval Road / Lake Isabella cluster just north of the Grapevine climb: TA #0239 Wheeler Ridge (5552 South Wheeler Ridge Road, Arvin) and Petro #0327 Wheeler Ridge (5821 Dennis McCarthy Dr., Lebec). Distinct from Flying J #616 Lebec at Frazier Mountain Park Rd on the <a href="/grapevine/">Grapevine / I-5 mid-CA</a> page. No ScaleRegistry dedicated walk-up house here. CDFA Kern grid did not load (WAF blocked). Mid-north Redding / Anderson still only has one own-page CAT (TA Redding #0057) — deferred. For Buttonwillow / Lost Hills farther north on I-5, use <a href="/buttonwillow-lost-hills/">Buttonwillow / Lost Hills / I-5</a>.</p>
    <p class="meta-line">{n} verified listings · {len(dedicated)} dedicated houses · {len(cat)} CAT stops · CDFA grid not loaded</p>
  </div>
</section>
<div class="wrap prose">
  {filters()}
  <div class="box box-call" id="dedicated">
    <h2>No verified dedicated public scale house at Wheeler Ridge</h2>
    <p>ScaleRegistry’s California public-weighing list still points to inland Central Valley houses (Selma / Merced / Lancaster) — <strong>no Wheeler Ridge / Arvin / Laval Road dedicated house</strong> verified on this compile. We are not inventing a civilian ticket shop from third-party trucker directories.</p>
  </div>

  <div data-filter-section>
  <h2 class="section-h" id="cat">CAT Scale at TA and Petro</h2>
  <p class="section-note">We list only corridor CAT stops verified on the operator’s own location page. TA #0239 (Wheeler Ridge / I-5 at Lake Isabella or Laval Road) lists CAT Scale; Petro #0327 (Wheeler Ridge / I-5 at Laval Road West) lists CAT Scale. 2,000 lb floor. No corner weights. Do not unload horses at a truck stop. In California, go inside for a printed weighmaster certificate when you need one. Use <a href="https://catscale.com/cat-scale-locator/">CAT’s locator</a> for other stops.</p>
  <div class="cards two">{cards_c}</div>
  </div>
...
<section class="page-head">
  <div class="wrap">
    ...
    <p class="lede">Two dedicated public houses on ScaleRegistry (Selma with an operator site; Merced Highway 59 with address and phone), Merced-county CAT including TA Livingston #0170 and the Santa Nella cluster, plus Kern County CAT Scales verified on Pilot Flying J and Love’s <em>own</em> location pages (Bakersfield Zachary, Bakersfield Taft Hwy, Lost Hills I-5, plus the Hwy 58 Tehachapi–Boron cluster also featured on <a href="/mojave/">Mojave / Hwy 58</a>). CDFA Kern (c=15), Fresno, and Merced facility grids did not load on this compile (WAF blocked), so this is not a full county table.</p>
...
def page_about():
    ...
    tul = [s for s in STATIONS if s["id"] in tul_ids]
    sal = [s for s in STATIONS if s["id"] in sal_ids]
    wy = [s for s in STATIONS if s["id"] in wy_ids]
...
def main():
    ...
    write(
        ROOT / "tulare" / "index.html",
        "Tulare / Hwy 99 public scales — Love’s #382, Flying J #1071 CAT | WeighHere",
        "Two CAT Scales verified on Love’s and Pilot Flying J own pages at Tulare CA-99 Exit 85. No dedicated house; CDFA Tulare grid not loaded.",
        "tul",
        "../",
        tulare_body(),
        leaflet,
    ...
    write(
        ROOT / "fresno" / "index.html",
        "Fresno County public scales — Selma dedicated, EZ Trip #1277 Huron CAT | WeighHere",
        "Selma Certified Public Scale plus EZ Trip #1277 Huron CAT verified on Pilot Flying J own page (I-5 Exit 319). Fresno-focused; CDFA Fresno grid not loaded.",
        "fre",
        "../",
        fresno_body(),
        leaflet,
    ...
    write(
        ROOT / "merced" / "index.html",
        "Merced / Hwy 99 public scales — Highway 59 Scales, TA Livingston #0170 CAT | WeighHere",
        "Highway 59 Scales (Merced dedicated) plus TA Livingston #0170 CAT verified on TA own page (SR 99 Exit 203). Merced-focused; CDFA Merced grid not loaded.",
        "mer",
        "../",
        merced_body(),
        leaflet,
    ...
    write(
        ROOT / "salinas" / "index.html",
        "Salinas / US-101 public scales — Love’s #898, Pilot #237 CAT | WeighHere",
        "Two CAT Scales verified on Love’s and Pilot Flying J own pages at Salinas US-101 Exit 326. No dedicated house; CDFA Monterey grid not loaded.",
        "sal",
        "../",
        salinas_body(),
        leaflet,
    ...
    write(
        ROOT / "weed-yreka" / "index.html",
        "Weed / Yreka / I-5 public scales — Pilot #137, EZ Trip #1343 CAT | WeighHere",
        "Two CAT Scales verified on Pilot Flying J own pages at Weed I-5 Exit 745 and Yreka I-5 Exit 776. No dedicated house; CDFA Siskiyou grid not loaded.",
        "wy",
        "../",
        weed_yreka_body(),
        leaflet,
    ...
    write(
        ROOT / "corning-orland" / "index.html",
        "Corning / Orland / I-5 public scales — Love’s #410, Pilot #1019 CAT | WeighHere",
        "Two CAT Scales verified on Love’s and Pilot Flying J own pages at Corning I-5 Exit 630 and Orland I-5 Exit 619. No dedicated house; CDFA Tehama/Glenn grids not loaded.",
        "co",
        "../",
        corning_orland_body(),
        leaflet,
    ...
    write(
        ROOT / "wheeler-ridge" / "index.html",
        "Wheeler Ridge / I-5 public scales — TA #0239, Petro #0327 CAT | WeighHere",
        "Two CAT Scales verified on TA and Petro own pages at Wheeler Ridge I-5 Laval Road / Lake Isabella. Distinct from Flying J Lebec on Grapevine; CDFA Kern grid not loaded.",
        "wr",
        "../",
        wheeler_ridge_body(),
        leaflet,
